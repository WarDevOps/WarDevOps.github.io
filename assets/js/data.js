...
export const translations = {
      en: {
        ...
        mapNewsTitle: "Sky Odyssey 26.09.17 Major Update",
        mapNewsDarwin: "New map added: Darwin Hill.",
        mapNewsRedDesert: "Red Desert map improved.",
        mapNewsVolokolamsk: "Minor changes to Volokolamsk.",
        ...
        editorTools: "Map editing tools",
        readMoreSummary: "Read more",
        readLessSummary: "Show less",
        editTacticalSummary: "Edit tactical summary",
        tacticalSummaryEnglish: "English summary",
        tacticalSummaryKorean: "Korean summary",
        tacticalSummaryEnglishPlaceholder: "Write an English tactical summary",
        tacticalSummaryKoreanPlaceholder: "Write a Korean tactical summary",
        tacticalSummaryEmpty: "No tactical summary has been added yet.",
        saveTacticalSummary: "Save Summary",
        tacticalSummarySaved: "Summary for this variation saved in this browser.",
        ...
        artilleryStrike: "Use Artillery Strike",
        ...
        confirmDeleteAllMarkers: "Delete every marker, route, and drawing from all maps and teams? This will replace your saved layout.",
        allMarkersDeleted: "All markers, routes, and drawings were deleted.",
        ...
        mapSyncConflict: "This map has both local and newer default changes.",
        useLatestMap: "Use Latest Map",
        confirmUseLatestMap: "Replace all local changes for this map with the latest default layout?",
        latestMapApplied: "The latest default layout was applied to this map.",
        defaultLayoutUpdated: "Latest default map updates were applied.",
        markerActions: "Marker actions",
        roleMarker: "Role Marker",
        tankMarkerType: "Tank Marker",
        addComment: "Add Comment",
        commentTitle: "Comment",
        closeComment: "Close comment",
        enlargeCommentImage: "Enlarge comment media",
        commentImagePreview: "Enlarged comment media",
        closeCommentImage: "Close enlarged comment media",
        commentPlaceholder: "Write a tactical note…",
        commentEnglish: "English comment",
        commentKorean: "Korean comment",
        commentEnglishPlaceholder: "Write an English tactical note…",
        commentKoreanPlaceholder: "Write a Korean tactical note…",
        commentImage: "Reference Media",
        noCommentImage: "No media",
        commentImageNavigation: "Comment media navigation",
        previousCommentImage: "Previous comment image",
        nextCommentImage: "Next comment image",
        commentImageLimitReached: "Up to 10 media items can be selected.",
        ...
        tankMarkerTypeChanged: "Tank marker type changed.",
      ...
      ko: {
        ...
        mapNewsTitle: "스카이 오디세이 26.09.17 메이저 업데이트",
        mapNewsDarwin: "신규 맵 다윈 힐 추가.",
        mapNewsRedDesert: "붉은 사막 맵 개선.",
        mapNewsVolokolamsk: "볼로콜람스크 맵 소규모 변경.",
        ...
        editorTools: "지도 편집 도구",
        readMoreSummary: "더 보기",
        readLessSummary: "접기",
        editTacticalSummary: "전술 요약 수정",
        tacticalSummaryEnglish: "영문 요약",
        tacticalSummaryKorean: "국문 요약",
        tacticalSummaryEnglishPlaceholder: "영문 전술 요약을 입력하세요",
        tacticalSummaryKoreanPlaceholder: "국문 전술 요약을 입력하세요",
        tacticalSummaryEmpty: "아직 전술 요약이 없습니다.",
        saveTacticalSummary: "요약 저장",
        tacticalSummarySaved: "이 바리에이션의 전술 요약을 브라우저에 저장했습니다.",
        ...
        deleteAllMarkers: "모든 마커 삭제",
        confirmDeleteAllMarkers: "모든 맵과 진영의 마커, 경로, 그림을 전부 삭제할까요? 저장된 배치가 교체됩니다.",
        allMarkersDeleted: "모든 마커, 경로, 그림을 삭제했습니다.",
        defaultLayoutRestored: "기본 마커 배치를 복원했습니다.",
        defaultLayoutLoadError: "기본 마커 배치를 불러오지 못했습니다.",
        mapSyncConflict: "이 맵의 로컬 편집과 최신 기본 배치가 모두 변경되었습니다.",
        useLatestMap: "이 맵 최신화",
        confirmUseLatestMap: "이 맵의 모든 로컬 변경을 최신 기본 배치로 교체할까요?",
        latestMapApplied: "이 맵에 최신 기본 배치를 적용했습니다.",
        defaultLayoutUpdated: "최신 기본 맵 업데이트를 적용했습니다.",
        markerActions: "마커 동작",
        roleMarker: "역할 마커",
        tankMarkerType: "전차 마커",
        addComment: "코멘트 추가",
        commentTitle: "코멘트",
        closeComment: "코멘트 닫기",
        enlargeCommentImage: "코멘트 미디어 확대",
        commentImagePreview: "확대된 코멘트 미디어",
        closeCommentImage: "확대된 코멘트 미디어 닫기",
        commentPlaceholder: "전술 메모를 작성하세요…",
        commentEnglish: "영어 코멘트",
        commentKorean: "한국어 코멘트",
        commentEnglishPlaceholder: "영어 전술 메모를 작성하세요…",
        commentKoreanPlaceholder: "한국어 전술 메모를 작성하세요…",
        commentImage: "참조 미디어",
        noCommentImage: "미디어 없음",
        commentImageNavigation: "코멘트 미디어 이동",
        previousCommentImage: "이전 코멘트 이미지",
        nextCommentImage: "다음 코멘트 이미지",
        commentImageLimitReached: "미디어는 최대 10개까지 선택할 수 있습니다.",
        saveComment: "코멘트 저장",
        cancel: "취소",
        ...
        tankMarkerTypeChanged: "전차 마커 종류를 변경했습니다.",
        mapDrawings: "지도 도형",
