...
export const translations = {
      en: {
        ...
        searchGuideTitle: "War Thunder Tactical Map Guide",
        searchGuideCopy: "Browse map layouts for both teams, compare key combat areas, and use tactical markers to plan routes, positions, and engagements before battle.",
        ...
        lastUpdated: "Last updated : 2026.08",
      ...
      ko: {
        pageTitle: "WarDevOps | War Thunder Map Tactic",
        metaDescription: "워썬더 지도, 진영별 위치, 전술 마커, 이동 경로와 주요 교전 지역을 WarDevOps MapTactic에서 살펴보세요.",
        brandName: "부릉부릉",
        ...
        heroTitleSecond: "THE WAR",
        heroCopy: "Know yourself and your enemy, and you will win every battle.",
        searchGuideTitle: "워썬더 전술 지도 가이드",
        searchGuideCopy: "양 진영의 지도 구성을 살펴보고 주요 교전 지역을 비교하세요. 전술 마커를 사용해 전투 전에 이동 경로, 위치, 교전 계획을 세울 수 있습니다.",
        searchLabel: "맵 검색",
        ...
        editorIdle: "편집 모드에서 마커 아이콘을 지도 위로 드래그해 배치하세요.",
        ...
        confirmResetAll: "모든 맵과 진영에 배치한 마커와 도형을 삭제할까요? 이 작업은 되돌릴 수 없습니다.",
        allMarkersReset: "배치한 모든 마커와 도형을 삭제했습니다.",
